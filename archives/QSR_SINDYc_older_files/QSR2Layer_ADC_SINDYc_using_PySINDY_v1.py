...
ax[1].plot(t_data['1.0'][initial:final],x_adc['1.0'][initial:final,0],
          alpha=0.7,
          label='ADC')
ax[2].plot(t_data['1.0'][initial+200:final],filtered_x_adc[initial+200:final,0],
          alpha=0.7,
          label='Filtered TOF')
...
x_adc_offline_filtered=filtered_x_adc[200:final,0]
x_adc_offline_filtered=x_adc_offline_filtered[...,np.newaxis]
u_adc_offline_filtered=u_data['1.0'][200:final,0]
# =============================================================================
...
u_QSR_DoubleLayer_all=u_adc_offline_filtered
# u_valid=  
...
stlsq_optimizer = ps.STLSQ(threshold=.000001, alpha=.5,normalize=False)
