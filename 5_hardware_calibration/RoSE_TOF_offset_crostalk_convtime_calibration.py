...
#importlib.reload(Class_vl6180x)
...
##            self.ADCbus.write_byte_data(self.ADC_ADDRESS,SETUP_BYTE)
    ...
    def InitializeIOExpanderAndChangeTOFAddress(self,
        ...
        for ii in range (0,Num_of_TOF):
            ...
            TOF_sensor.append(VL6180X(i2c,
                                          new_address=VL6180X_NEW_I2C_ADDR[ii]
                                          )
                              )
            time.sleep(0.5)
            
        TOF_sensor[0].rangeoffsetcalibration
...
if __name__ == '__main__':
    ...
    try:
        ...
        TOFADCPer2dArray=np.array([[],\
                                   ...
                                   [],[],[],[],[],[],[],[],[],[],[],[],\
                                   [],[],[],[],[],[],[],[],[],[],[],[]]).T
#        range_mm_array=QSR_Two_layer.GenerateDisplacementDataFromTOF(t1 = timedelta(minutes = 0, seconds = 0, microseconds=0))
