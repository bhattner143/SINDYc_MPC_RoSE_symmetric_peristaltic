...
class SINDyBase(object):
    ...
    def finite_difference_2(self, data, _dt, poly_degree=2, cut_off=1e-3, deriv_acc=2):
        """
...
#                        print(_t + (_x,))
    ...
    def polynomial_expansion(self,data, degree=1, remove_zero_order=False, var_names=None):
        """
    ...
    @staticmethod
    def threshold_ls(mtx, _b, lam_bda=1e-3, max_iter=10, normalize=0):
        """
...
#        compute Sparse regression: sequential least squares
    ...
    def sparsify_dynamics(self,mtx, _b, lam_bda, max_iter=25, thresh_iter=10,
