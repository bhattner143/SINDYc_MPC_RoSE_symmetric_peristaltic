...
#                    linewidth=1.5)
        ...
        ax2 = f1.add_subplot(612)
        ax2.plot(xref_traj.T[:,1],
                color='g',
                linewidth=1.5,
                linestyle='--')
        ...
        ax3 = f1.add_subplot(613)
        ax3.plot(xref_traj.T[:,2],
                color='b',
                linewidth=1.5,
                linestyle='--')
