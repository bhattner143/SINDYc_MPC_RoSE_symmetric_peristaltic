...
# =============================================================================
    ...
    model_discrete.fit(x_RoSEv2pt0_adc_train, u=u_RoSEv2pt0_train)
    ...
    for i in range (1,2):
        ax3[i].plot(np.arange(0,FinPt1),x_RoSEv2pt0_adc_all[0:FinPt1,i-1],#/np.max(x_QSR_DoubleLayer_tof_all[0:FinPt]),
                    'r',label='training')
        ax3[i].plot(np.arange(FinPt1,FinPt2),x_RoSEv2pt0_adc_all[FinPt1:FinPt2,i-1],#/np.max(x_QSR_DoubleLayer_tof_all[0:FinPt]),
                    'g',label='validation')
        ax3[i].plot(np.arange(0,FinPt3),x_RoSEv2pt0_adc_all_sim[0:FinPt3,i-1],#/np.max(x_QSR_DoubleLayer_tof_all_sim[0:FinPt]),
