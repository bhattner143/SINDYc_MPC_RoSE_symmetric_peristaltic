...
from archives.QSR_TwoLayer_IOEXpander_TOF_OOPs import* 
...
#        pdb.set_trace()
    ...
    def GenerateRobotSINDYcModel(self,
        ...
        if discrete_model is True:
            ...
            u_robot_train=self.DataDictionary['u_train'][:,0]
    
            x_robot_adc_train=self.DataDictionary['x_train'][:,0]
    ...
    # =============================================================================
    def RobotObjectiveFCN(self,u,x,Ts,N,xref,u0,Q,R,Ru):
...
def sindyc_model():
   # =============================================================================
    ...
    """
    QSR_DoubleLayer_Obj_SINDYc_SI.FileReading( [16,14,17,2,10,0,4])
...
#              label='Online Filtered TOF') 
    ...
    for i in range(threshold_vec.shape[0]):
        ...
        try:
            ...
            x_robot_adc_valid_sim=QSR_DoubleLayer_Obj_SINDYc_SI.SimulateRobotSINDYcModel(x0_robot_adc_valid,
                                                                   N,
                                                                   u_robot_valid[0:N])
...
#                      alpha=0.7,
#                      label='Input')
#            ax3[1].plot(n_dis, x_robot_adc_valid[0:FinPt],#/np.max(x_QSR_DoubleLayer_tof_all[0:FinPt]),
#                  'k', label='true simulation')
#            ax3[1].plot(n_dis, x_robot_adc_valid_sim[0:FinPt],#/np.max(x_QSR_DoubleLayer_tof_all_sim[0:FinPt]),
...
#            plt.show()
            ...
            xk1=QSR_DoubleLayer_Obj_SINDYc_SI.PredictRobotSINDYcModel(x0_robot_adc_valid,u_control)
            
               
            xk_sim=QSR_DoubleLayer_Obj_SINDYc_SI.SimulateRobotSINDYcModel(x0_robot_adc_valid,
                                                                   u_control.shape[0],
                                                                   u_control)
        ...
        #    plt.show()
            ...
            return QSR_DoubleLayer_Obj_SINDYc_SI
