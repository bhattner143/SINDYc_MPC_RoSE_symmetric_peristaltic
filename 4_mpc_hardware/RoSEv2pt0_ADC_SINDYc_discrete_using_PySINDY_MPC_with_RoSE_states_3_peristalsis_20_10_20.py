...
#                    pdb.set_trace()
                ################################    
                if xref[0]>=72.6 and xref[0]<74:
                    LB1=40 #Lower bound
                    UB1=44 #Upper bound
                    
                elif xref[0]>=70 and xref[0]<72.6:
                    LB1=30 #Lower bound
                    UB1=36 #Upper bound
...
#            x_filtered, z_adc_packed=filtering(x_adc,z_adc_packed)
            #Removing offsets
            x_adc_filtered[0,0]=x_adc_filtered[0,0]+17-2
            x_adc_filtered[0,1]=x_adc_filtered[0,1]+15.5
            x_adc_filtered[0,2]=x_adc_filtered[0,2]+12
            x=x_adc_filtered
        ...
        HistoryDict={
                  't':tHistory,
                  'x_ref_1':(5/256*xref_traj[0,:]-1)*125,
                  'x_ref_2':(5/256*xref_traj[1,:]-1)*125,
                  'x_ref_3':(5/256*xref_traj[2,:]-1)*125,
                  'x_1':(5/256*xHistory[:,0]-1)*125,
                  'x_2':(5/256*xHistory[:,1]-1)*125,
                  'x_3':(5/256*xHistory[:,2]-1)*125,#(5v/256*ADC_data-1)*125
        ...
        History_df.to_csv('DataFiles/Data31_10_2020_Peristalsis_experiment_with_MPC/data_controller_4.csv')
