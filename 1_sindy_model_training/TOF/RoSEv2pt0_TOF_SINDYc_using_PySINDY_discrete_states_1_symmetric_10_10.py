...
RoSEv2pt0_TOFADCandPer.FileReading([5,6,7,8,4])#8,5,6,7
#12,13
...
threshold_vec=np.array([0.00004])#0.0008
...
# =============================================================================
    ...
    model_discrete.fit(x_RoSEv2pt0_tof_train[:-1], t=1.0, x_dot=x_RoSEv2pt0_tof_train[1:], u=u_RoSEv2pt0_train[:-1])
    ...
    x0_RoSEv2pt0_tof_all=x_RoSEv2pt0_tof_all[0,np.newaxis]
    ...
    x_RoSEv2pt0_tof_all_sim=np.zeros((N_all,1))
    x_RoSEv2pt0_tof_all_sim[0,:]=x0_RoSEv2pt0_tof_all
    """
    ...
    for ii in range(1,N_all):
        x_RoSEv2pt0_tof_all_sim[ii] = model_discrete.predict(x0_RoSEv2pt0_tof_all, 
                                                  u_RoSEv2pt0_dummy_test[ii-1:ii])
        # print(u_RoSEv2pt0_all[ii-1:ii])
        # print(x_RoSEv2pt0_adc_all_sim[ii])
        x0_RoSEv2pt0_tof_all=x_RoSEv2pt0_tof_all_sim[ii]
    ...
    for i in range (1,2):
        ax3[i].plot(np.arange(0,FinPt1),x_RoSEv2pt0_tof_all[0:FinPt1,i-1],#/np.max(x_QSR_DoubleLayer_tof_all[0:FinPt]),
                    'r',label='training')
        ax3[i].plot(np.arange(FinPt1,FinPt2),x_RoSEv2pt0_tof_all[FinPt1:FinPt2,i-1],#/np.max(x_QSR_DoubleLayer_tof_all[0:FinPt]),
                    'g',label='validation')
        ax3[i].plot(np.arange(0,FinPt3),x_RoSEv2pt0_tof_all_sim[0:FinPt3,i-1],#/np.max(x_QSR_DoubleLayer_tof_all_sim[0:FinPt]),
