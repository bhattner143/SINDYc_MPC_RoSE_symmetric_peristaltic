...
#        pdb.set_trace()
    ...
    def GenerateRobotSINDYcModel(self,
        ...
        if discrete_model is True:
            ...
            self.model = ps.DiscreteSINDy(optimizer=stlsq_optimizer,
                feature_library=library_sindyc
                )
            
            self.model.fit(x_robot_adc_train, 1, u=u_robot_train)
    ...
    def SimulateRobotSINDYcModel(self,x0,N,u):
        ...
        if isinstance(self.model, ps.DiscreteSINDy):
...
def sindyc_model():
    ...
    """
    QSR_DoubleLayer_Obj_SINDYc_SI.FileReading( [2,10,0,4])
