...
#    D = 0                          # Feedforward (none)
    ...
    for ct in range(int(Duration/Ts)):
        ...
        if ct*Ts>30:   # Turn control on
            ...
            EQ_CON={'type':'eq',
                    'fun': lambda ceq: np.array([])}
            
            IN_CON={'type':'ineq',
                 'fun':obj.lotkaConstraintFCN,
                 'args':(x,Ts,N,pest)
                 }
        ...
        #    pdb.set_trace()
            uopt=minimize(obj.lotkaObjectiveFCN,
                          uopt,
                          method='SLSQP',
...
# =============================================================================
    ...
    ax1.set_xlabel(r"Time t (s)", size=12)
    ax1.set_ylabel(r"Cost function value J", size=12)
    plt.show()
    
    # f2.savefig('Plots/MPC/CostFunVal_N_'+str(i)+'.png', bbox_inches='tight',dpi=300)
...
# =============================================================================
    ...
    ax1.set_xlabel(r"Time t (s)", size=12)
    ax1.set_ylabel(r"Control u(t)", size=12)
    plt.show()
    
    # f3.savefig('Plots/MPC/Control_N_'+str(i)+'.png', bbox_inches='tight',dpi=300)